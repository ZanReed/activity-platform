...
| Question types + pedagogical blocks + calculator + reference panel + typography | ✅ Live in the viewer — **EXCEPT the student calculator**, which died with the published-page runtime at S9 Drop 4 and was still marked live here until the 2026-08-22 §9 sweep (see the TODOS orphan entry; the editor's config knob stores a field nothing student-facing reads) |
