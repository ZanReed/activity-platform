...
| Calculator tool (Phase 2.7) | ✅ Stages 1–4 + full graphing UX overhaul (floating panel, in-panel MathLive keyboard, splitter, hover-trace, sticky axes, calc results) — all browser-verified at `/dev/calculator` ([HISTORY 2026-07-06](docs/HISTORY.md)). Kit `graph-kit-ZMCQEGJA.js` uploaded + `publish-activity` redeployed 2026-07-06 — reaches a page on its next re-publish (pending action #2). Next: Stage 5 (graded interactions) or Stage 4 polish (comma key, spreadsheet paste) |
