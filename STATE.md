...
| Calculator tool (Phase 2.7, Stage 1 — scientific) | 🛠️ In progress: schema (`77ff8e3`) + renderer (`d7cf6cf`) + widget/`@activity/graph-kit` (`9f82383`, browser-verified) slices shipped + committed + tested. Remaining: build-hosting (kit→R2) + editor authoring control. Decisions locked (math.js evaluator, shared R2 kit) |
