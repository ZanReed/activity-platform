...
3. **R2 teardown station** — [s9-cutover.md](docs/design/s9-cutover.md) §8 verbatim. **Both pre-checks RAN 2026-08-14; read these before the station:**
   ...
   - **⏭ ONE STEP LEFT: bucket delete** — `activity-platform-published`, Cloudflare dashboard. Nothing depends on it; the archive is `r2-final-backup-20260815/`. The old test-page URLs die with it, as ruled.
