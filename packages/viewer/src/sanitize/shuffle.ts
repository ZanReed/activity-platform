...
// seedFrom + mulberry32 moved to prng.ts (a leaf) so the seed-value
// derivation shares the exact primitives — two PRNG copies drifting would be
// the two-spellings bug all over again, one layer down.
