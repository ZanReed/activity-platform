import{c as V,h as te,j as ae,k as ne,l as re}from"./graph-kit-chunk-ZGBADNMA.js";import{c as W,d as J,e as Q,i as Z,k as j,n as ee}from"./graph-kit-chunk-O35MR3CL.js";import{c as oe,o as G,p as m}from"./graph-kit-chunk-2VMOZRK7.js";function ie(){return window.mathVirtualKeyboard}function me(t){return Number.isInteger(t)&&Math.abs(t)<1e15?String(t):String(Number.parseFloat(t.toPrecision(12)))}function ke(t){let k=Math.max(10,Math.ceil(Math.abs(t)*2));return{min:-k,max:k}}function le(t,k){return k?u=>Z(u,k)?t(u):NaN:t}function he(t,k,u){let l=(p,w)=>t.g(p,w,k),r=W(l);if(r.kind==="error")return r.message;let z=t.op==="<"||t.op===">";return r.kind==="vertical"?t.domain?"A 'for x \u2026' restriction doesn't apply to a vertical boundary":{kind:"inequality",color:u,strict:z,side:Q(l,r.x,t.op),boundary:{type:"vertical",x:()=>{let p=l(0,0),w=l(1,0)-p;return Math.abs(w)<1e-12?NaN:-p/w}}}:{kind:"inequality",color:u,strict:z,side:J(l,r.fn,t.op),boundary:{type:"fn",fn:le(r.fn,t.domain)}}}function se(t){let k=document.createElement("div");k.className="gk-exprlist";let u=document.createElement("div");u.className="gk-exprlist-rows";let l=document.createElement("div");l.className="gk-exprlist-cap",l.hidden=!0,k.append(u,l);let r=[],z=0,p={},w=()=>t.maxRows!==void 0&&r.length>=t.maxRows;function s(){t.maxRows!==void 0&&w()?(l.hidden=!1,l.textContent=`Expression limit for this activity: ${t.maxRows}`):l.hidden=!0}function T(){let n=r[r.length-1];n&&n.field.getValue("ascii-math")!==""&&!w()&&M();for(let o of r){let a=o.field.getValue("ascii-math");a!==o.lastText&&(o.classified=ee(a,t.opts()),o.lastText=a,o.dragValue=null)}for(let o of Object.keys(p))delete p[o];for(let o of r)o.classified.kind==="slider"&&(p[o.classified.name]=o.dragValue??o.classified.value);let v=[];for(let o of r){let a=o.classified,f=null;if(a.kind==="inequality"){let c=he(a,p,o.color);typeof c=="string"?f=c:v.push(c)}if(a.kind==="error"||f?(o.note.textContent=a.kind==="error"?a.message:f,o.note.dataset.kind="error"):a.kind==="calculation"?(o.note.textContent="= "+me(a.value),o.note.dataset.kind="calc"):(o.note.textContent="",delete o.note.dataset.kind),o.sliderBox.hidden=a.kind!=="slider",a.kind==="slider"?K(o,a.name):o.sliderBox.textContent="",a.kind==="function"){let c=a.fn;v.push({kind:"curve",color:o.color,fn:le(x=>c(x,p),a.domain)})}else if(a.kind==="point"){let{px:c,py:x}=a;v.push({kind:"point",color:o.color,px:()=>c(p),py:()=>x(p)})}}s(),t.onPlotsChange(v)}function K(n,v){let o=p[v]??0,a=n.sliderBox.querySelector("input"),f=n.sliderBox.querySelector("span");(!a||!f)&&(n.sliderBox.textContent="",f=document.createElement("span"),f.className="gk-slider-label",a=document.createElement("input"),a.type="range",a.className="gk-slider-range",a.addEventListener("input",()=>{let g=Number(a.value);n.dragValue=g,n.classified.kind==="slider"&&(p[n.classified.name]=g,f.textContent=`${n.classified.name} = ${g}`),t.onScopeDrag()}),n.sliderBox.append(f,a));let{min:c,max:x}=ke(n.dragValue??o);a.min=String(c),a.max=String(x),a.step=String((x-c)/200),a.value=String(o),a.setAttribute("aria-label",`Value of ${v}`),f.textContent=`${v} = ${o}`}function M(){let n={wrap:document.createElement("div"),field:new V,color:G[z++%G.length]??oe,note:document.createElement("div"),sliderBox:document.createElement("div"),lastText:null,classified:{kind:"empty"},dragValue:null};n.wrap.className="gk-exprrow",n.note.className="gk-exprrow-note",n.sliderBox.className="gk-exprrow-slider",n.sliderBox.hidden=!0;let v=document.createElement("div");v.className="gk-exprrow-line";let o=document.createElement("span");o.className="gk-exprrow-dot",o.style.background=n.color,n.field.className="gk-exprfield",n.field.mathVirtualKeyboardPolicy="manual";let a=document.createElement("button");a.type="button",a.className="gk-exprrow-kb",a.setAttribute("aria-label","Show or hide the on-screen keyboard"),a.title="On-screen keyboard",a.setAttribute("aria-pressed","false"),a.textContent="\u2328",a.addEventListener("pointerdown",c=>c.preventDefault()),a.addEventListener("click",()=>{var g;n.field.focus();let c=ie();if(!c)return;c.visible?c.hide():c.show();let x=!!((g=ie())!=null&&g.visible);u.querySelectorAll(".gk-exprrow-kb").forEach(R=>R.setAttribute("aria-pressed",String(x)))});let f=document.createElement("button");f.type="button",f.className="gk-exprrow-remove",f.setAttribute("aria-label","Remove expression"),f.textContent="\xD7",n.field.addEventListener("focus",()=>t.onFieldFocus(n.field)),n.field.addEventListener("input",T),v.addEventListener("click",c=>{let x=c.target;x.closest("button")||x.closest("math-field")||n.field.focus()}),f.addEventListener("click",()=>{if(r.length>1){let c=r.indexOf(n);c!==-1&&r.splice(c,1);try{n.field.blur()}catch{}n.wrap.remove()}else n.field.value="",n.lastText=null;T()}),v.append(o,n.field,a,f),n.wrap.append(v,n.sliderBox,n.note),r.push(n),u.appendChild(n.wrap),s()}return M(),{root:k,rebuild:T,reclassifyAll(){for(let n of r)n.lastText=null;T()},destroy(){for(let n of r)try{n.field.blur()}catch{}k.remove()}}}var de=["linear","quadratic","exponential","logarithmic"];function be(t){let k=typeof t=="object"&&t!==null?t:{},u=k.allowedRegressionModels,l=k.maxExpressions;return{mode:k.mode==="graphing"?"graphing":"scientific",allowTrig:k.allowTrig!==!1,allowLogExp:k.allowLogExp!==!1,allowInequalities:k.allowInequalities!==!1,allowedRegressionModels:Array.isArray(u)?de.filter(r=>u.includes(r)):de,maxExpressions:typeof l=="number"&&Number.isInteger(l)&&l>=1?l:void 0}}function ce(t){return Number.isInteger(t)&&Math.abs(t)<1e15?String(t):String(Number.parseFloat(t.toPrecision(12)))}var ge=[{label:"sin",action:{insert:"\\sin("},gate:"trig",variant:"fn"},{label:"cos",action:{insert:"\\cos("},gate:"trig",variant:"fn"},{label:"tan",action:{insert:"\\tan("},gate:"trig",variant:"fn"},{label:"ln",action:{insert:"\\ln("},gate:"logexp",variant:"fn"},{label:"log",action:{insert:"\\log("},gate:"logexp",variant:"fn"},{label:"x\xB2",action:{insert:"^{2}"},variant:"fn"},{label:"x\u02B8",action:{insert:"^{#?}"},variant:"fn"},{label:"\u221A",action:{insert:"\\sqrt{#?}"},variant:"fn"},{label:"\u03C0",action:{insert:"\\pi"},variant:"fn"},{label:"e",action:{insert:"e"},variant:"fn"},{label:"7",action:{insert:"7"},variant:"num"},{label:"8",action:{insert:"8"},variant:"num"},{label:"9",action:{insert:"9"},variant:"num"},{label:"(",action:{insert:"("},variant:"op"},{label:")",action:{insert:")"},variant:"op"},{label:"4",action:{insert:"4"},variant:"num"},{label:"5",action:{insert:"5"},variant:"num"},{label:"6",action:{insert:"6"},variant:"num"},{label:"\xD7",action:{insert:"\\times"},variant:"op"},{label:"\xF7",action:{insert:"\\div"},variant:"op"},{label:"1",action:{insert:"1"},variant:"num"},{label:"2",action:{insert:"2"},variant:"num"},{label:"3",action:{insert:"3"},variant:"num"},{label:"+",action:{insert:"+"},variant:"op"},{label:"\u2212",action:{insert:"-"},variant:"op"},{label:"0",action:{insert:"0"},variant:"num"},{label:".",action:{insert:"."},variant:"num"},{label:"!",action:{insert:"!"},variant:"op"},{label:"C",action:{clear:!0},variant:"accent"},{label:"\u232B",action:{cmd:"deleteBackward"},variant:"accent"}];function h(t,k,u={}){let l=document.createElement(t);l.className=k;for(let[r,z]of Object.entries(u))l.setAttribute(r,z);return l}var ve="0.109.2",ue=!1;function xe(){ue||(ue=!0,V.fontsDirectory=`https://cdn.jsdelivr.net/npm/mathlive@${ve}/dist/fonts`,V.soundsDirectory=null)}var X=!1;function ye(){if(X||document.getElementById("graph-kit-styles")){X=!0;return}let t=document.createElement("style");t.id="graph-kit-styles",t.textContent=Ce,document.head.appendChild(t),X=!0}var L={};function we(){return window.mathVirtualKeyboard}function Ee(t){var k;try{t.layouts=["numeric"];let u=(k=t.normalizedLayouts)==null?void 0:k[0];if(!(u!=null&&u.layers))return"numeric";let l=structuredClone(u),r={latex:",",label:",",class:"big-op hide-shift"},z=p=>typeof p!="string"&&typeof p.command=="string"&&p.command.includes("insertDecimalSeparator");for(let p of l.layers??[])for(let w of p.rows??[]){let s=w.findIndex(z);if(s>=0)return w.splice(s+1,0,r),[l]}return"numeric"}catch{return"numeric"}}function Pe(t,k,u={}){var U;ye(),xe();let l=be(k),r=l.mode==="graphing",z=u.floating??!1,p=r?"rad":"deg",w=!1,s=h("div","gk-cal",{role:"dialog","aria-label":"Calculator"});z&&s.classList.add("gk-cal-floating");let T=r?l.allowedRegressionModels:[],K=T.length>0,M=h("div","gk-cal-header"),n=h("span","gk-cal-title");n.textContent="Calculator";let v=h("button","gk-cal-data-btn",{type:"button","aria-pressed":"false","aria-label":"Toggle the data and regression panel"});v.textContent="Data";let o=h("button","gk-cal-angle",{type:"button","aria-label":"Toggle degrees or radians"});o.textContent=p.toUpperCase();let a=h("button","gk-cal-close",{type:"button","aria-label":"Close calculator"});a.textContent="\xD7",K?M.append(n,v,o,a):M.append(n,o,a);let f=new V;f.className="gk-cal-field",f.mathVirtualKeyboardPolicy="manual";let c=h("div","gk-cal-result",{"aria-live":"polite"}),x=h("div","gk-cal-graph"),g=null,R=null,H=r?null:f,E=r?se({opts:()=>({angleMode:p,allowTrig:l.allowTrig,allowLogExp:l.allowLogExp,allowInequalities:l.allowInequalities}),maxRows:l.maxExpressions,onPlotsChange:e=>{g?g.setPlots(e):R=e},onScopeDrag:()=>g==null?void 0:g.refresh(),onFieldFocus:e=>{H=e}}):null,P=h("div","gk-cal-data");P.hidden=!0;let B=null,$=T[0]??"linear",S=h("div","gk-cal-fit",{"aria-live":"polite"});function I(){if(!B)return;let e=B.getPoints();g==null||g.setScatter(e);let i=te($,e);if(S.textContent="",i.ok){g==null||g.plotFit(i.predict);let d=h("div","gk-fit-eq");d.textContent=ae(i.fit);let C=h("div","gk-fit-r2");C.textContent=ne(i.fit),S.append(d,C),S.dataset.state="ok"}else{g==null||g.plotFit(null),S.textContent=i.error;let d=e.length>=($==="quadratic"?3:2);S.dataset.state=d?"err":"hint"}}if(K){let e=h("div","gk-data-scroll");B=re(e,I);let i=h("div","gk-fit-controls"),d=h("select","gk-fit-model",{"aria-label":"Regression model"});for(let b of T){let y=h("option","");y.value=b,y.textContent=b.charAt(0).toUpperCase()+b.slice(1),d.appendChild(y)}d.addEventListener("change",()=>{$=T.find(b=>b===d.value)??$,I()});let C=h("button","gk-fit-view-btn",{type:"button","aria-label":"Fit the view to the data points"});C.textContent="Fit view",C.addEventListener("click",()=>{B&&(g==null||g.fitView(B.getPoints()))}),i.append(d,C),P.append(e,i,S)}let O=!1;function pe(e){O=e,v.setAttribute("aria-pressed",String(e)),s.dataset.view=e?"data":"expr",P.hidden=!e,e&&I()}v.addEventListener("click",()=>pe(!O));let F=h("div","gk-cal-keypad");function _(){if(r)return;let e=f.getValue("ascii-math"),i=j(e,{angleMode:p,allowTrig:l.allowTrig,allowLogExp:l.allowLogExp});i.ok?(c.textContent="= "+ce(i.value),c.dataset.state="ok"):i.error?(c.textContent=i.error,c.dataset.state="err"):(c.textContent="",delete c.dataset.state)}function Y(e){let i=H??(E?E.root.querySelector("math-field"):null);if(!i)return;let d=e.action;if("insert"in d)i.insert(d.insert);else if("cmd"in d)i.executeCommand(d.cmd);else if("clear"in d)i.value="";else if("equals"in d){let C=j(i.getValue("ascii-math"),{angleMode:p,allowTrig:l.allowTrig,allowLogExp:l.allowLogExp});C.ok&&(i.value=ce(C.value))}i.focus(),r?E==null||E.rebuild():_()}let fe=r?ge.map(e=>e.label==="!"?{label:"x",action:{insert:"x"},variant:"fn"}:e):ge;for(let e of fe){let i=h("button","gk-cal-key",{type:"button"});e.variant&&(i.dataset.variant=e.variant),i.textContent=e.label,e.gate==="trig"&&!l.allowTrig||e.gate==="logexp"&&!l.allowLogExp?(i.disabled=!0,i.title="Turned off for this activity"):i.addEventListener("click",()=>Y(e)),F.appendChild(i)}let A=h("button","gk-cal-key gk-cal-equals",{type:"button"});if(A.dataset.variant="equals",A.textContent="=",A.addEventListener("click",()=>Y(r?{label:"=",action:{insert:"="}}:{label:"=",action:{equals:!0}})),F.appendChild(A),s.dataset.mode=l.mode,r&&E){let e=h("div","gk-cal-body"),i=h("div","gk-cal-left");i.append(E.root,P);let d=h("div","gk-cal-splitter",{role:"separator","aria-orientation":"vertical","aria-label":"Resize the expression list"}),C=!1;d.addEventListener("pointerdown",y=>{C=!0,d.setPointerCapture(y.pointerId),y.preventDefault()}),d.addEventListener("pointermove",y=>{if(!C)return;let q=e.getBoundingClientRect(),D=Math.min(Math.max(y.clientX-q.left,112),q.width-128);i.style.flexBasis=D+"px",L.splitBasis=D+"px"});let b=y=>{C=!1;try{d.releasePointerCapture(y.pointerId)}catch{}};d.addEventListener("pointerup",b),d.addEventListener("pointercancel",b),L.splitBasis&&(i.style.flexBasis=L.splitBasis),e.append(i,d,x),s.append(M,e),s.dataset.view="expr"}else s.append(M,f,c,F);if(r||f.addEventListener("input",_),s.addEventListener("keydown",e=>{e.key==="Escape"&&(e.stopPropagation(),N(!1))}),o.addEventListener("click",()=>{p=p==="deg"?"rad":"deg",o.textContent=p.toUpperCase(),r?E==null||E.reclassifyAll():(f.focus(),_())}),a.addEventListener("click",()=>N(!1)),z){let e=0,i=0,d=!1;M.addEventListener("pointerdown",b=>{if(b.target.closest("button"))return;d=!0;let y=s.getBoundingClientRect();s.style.left=y.left+"px",s.style.top=y.top+"px",s.style.right="auto",s.style.bottom="auto",e=b.clientX-y.left,i=b.clientY-y.top,M.setPointerCapture(b.pointerId),b.preventDefault()}),M.addEventListener("pointermove",b=>{if(!d)return;let y=s.offsetWidth,q=Math.min(Math.max(b.clientX-e,8-y+64),window.innerWidth-64),D=Math.min(Math.max(b.clientY-i,8),window.innerHeight-40);s.style.left=q+"px",s.style.top=D+"px",L.left=q,L.top=D});let C=b=>{d=!1;try{M.releasePointerCapture(b.pointerId)}catch{}};M.addEventListener("pointerup",C),M.addEventListener("pointercancel",C),L.width&&(s.style.width=L.width),L.height&&(s.style.height=L.height),L.left!=null&&L.top!=null&&(s.style.left=L.left+"px",s.style.top=L.top+"px",s.style.right="auto",s.style.bottom="auto")}if(t.appendChild(s),r){let e=we();if(e)try{e.layouts=Ee(e),e.container=s}catch{}}r&&(x.textContent="Loading graph\u2026",import("./graph-kit-chunk-F7YIL4GZ.js").then(({createBoard:e})=>{x.textContent="",g=e(x,"light"),R&&(g.setPlots(R),R=null),O&&I()}).catch(e=>{x.textContent="Graph failed to load",console.error("Calculator board failed to load",e)}));function N(e){var i,d;e!==w&&(w=e,t.hidden=!e,e&&(r?(i=H??(E==null?void 0:E.root.querySelector("math-field")))==null||i.focus():f.focus()),(d=u.onToggle)==null||d.call(u,e))}return w=!0,t.hidden=!1,(U=u.onToggle)==null||U.call(u,!0),{get isOpen(){return w},open:()=>N(!0),close:()=>N(!1),toggle:()=>N(!w),destroy:()=>{z&&(s.style.width&&(L.width=s.style.width),s.style.height&&(L.height=s.style.height));try{f.blur()}catch{}E==null||E.destroy(),g==null||g.destroy(),s.remove()}}}var Ce=`
.gk-cal {
