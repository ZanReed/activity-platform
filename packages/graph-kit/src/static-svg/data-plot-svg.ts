...
export function renderDataPlotSvg(
  ...
  return (
    ...
    // See graph-svg.ts. A data plot's "drawables" are the plotted VALUES: a
    // build-the-chart question prints an empty frame (0), a display chart
    // prints the data it exists to show.
    ` data-drawables="${values.length}"` +
