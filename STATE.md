...
Test counts at last session: schema 101 / renderer 290 / app 245; `tsc -b` + app build green. (Inline vocabulary definitions + the rich-content/image upgrade.)
...
**Last updated:** 2026-06-19. Completed-session narratives are archived in [HISTORY.md](docs/HISTORY.md) (rolling log, newest first); durable reasoning in [DECISIONS.md](docs/DECISIONS.md). Suite at last session: schema 101 / renderer 290 / app 245; CI green.
