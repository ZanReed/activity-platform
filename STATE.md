...
**Last updated:** 2026-07-12 (Phase 2 block-type family COMPLETE + DEPLOYED — all four pedagogical blocks shipped and their markdown-import fences added; author ran the ordered deploy train (ingest v9 → publish). Suite 1663 green. Deck clear; **next arc: Phase 2.6 short_answer / essay** — the GRADED free-text siblings that reuse self-explanation's `freeResponses` map).
